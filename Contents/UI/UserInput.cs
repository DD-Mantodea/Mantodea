...
namespace Mantodea.Contents.UI
{
    public class UserInput
    {
        ...
        public delegate void CharEnteredHandler(object sender, TextInputEventArgs args);
        ...
        private static void TextInput(object sender, TextInputEventArgs args)
        {
            if (!SpecialCharacters.Contains(args.Character))
                CharPressed?.Invoke(sender, args);
        }
        ...
        public static Vector2 GetMousePos() => new(CurrentMouseState.X, CurrentMouseState.Y);
    ...
    {
        public Keys KeyCode { get; private set; } = keyCode;

        public bool Cancel = false;
    }

    public class CharacterEventArgs(char character) : EventArgs
    {
